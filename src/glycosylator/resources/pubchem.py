...
"""
Mapping of SDF bond types to Glycosylator bond types.
"""
...
def pubchem_to_cif(json_file: str, sdf_file: str, id: str = None, cif_file: str = None):
    ...
    a PubChem component for use in Glycosylator - i.e. to relabel atoms as required by the
    ...
    a CIF file from them which can be loaded into Glycosylator using the `PDBECompounds` class.
