        ...
        for a in atoms:
            ...
            if ic:
                ...
                for atom_ic in ic[0:4]:
                    ...
                    c += 1
                # xa0, xa1, xa2 created by exec statements within for loop above
                atom.setCoords(self.build_cartesian(xa0, xa1, xa2, ic[8], ic[7], ic[6]))  # type: ignore
